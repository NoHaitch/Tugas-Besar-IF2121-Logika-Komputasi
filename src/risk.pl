...
disease(P) :- 
    ...
    format('Player ~w mendapatkan risk card DISEASE.~nHingga giliran berikutnya, wilayah pemain tidak dapat diserang oleh lawan.~n', [Name]).
...
supplychain(P) :- 
    ...
    format('Player ~w mendapatkan risk card SUPPLY CHAIN.~nHingga giliran berikutnya, wilayah pemain tidak dapat diserang oleh lawan.~n', [Name]).
